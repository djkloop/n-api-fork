...
func InitOptionMap() {
	...
	common.OptionMap["RegistrationCaptchaEnabled"] = strconv.FormatBool(common.RegistrationCaptchaEnabled)
	common.OptionMap["RegistrationCaptchaWeights"] = common.RegistrationCaptchaWeights
...
func validateOptionValue(key string, value string) error {
	...
	if key == "payment_setting.return_origins" {
		return operation_setting.ValidatePaymentReturnOrigins(value)
	}
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "RegistrationCaptchaEnabled":
			common.RegistrationCaptchaEnabled = boolValue
		case "RegistrationCaptchaWeights":
			common.RegistrationCaptchaWeights = value
