...
export const STATIC_I18N_KEYS = [
  ...
  'Linux',
  'Fast setup',
  'Create a working route in seconds.',
  'Reliable routing',
  'Keep model access behind one stable contract.',
  'Global reach',
  'Balance traffic across providers and regions.',
  'Developer first',
  'Use the tools and protocols your team already knows.',
  'Live catalog',
  'Usage billing',
  'Group routing',
  'Standard model group',
  'Developer-friendly routing',
  'Efficient everyday usage',
